...
/**
 * A grafikus kötél megjelenitését megvalósitó osztály.
 */
public class GraphicsRope extends GraphicsTool {

	/**
	 * A Draw függvényt valósitja meg a kötél grafikus elemre.
	 * @param g - Graphics objektum, amelyre kerül a megjelenitet, kötélnek megfelelõ kép.
